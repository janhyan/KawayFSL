...
def makePrediction(sequence):
    ...
    model.load_weights(r"C:\Users\hyanx\Documents\repos\KawayFSL\terraform\src\introduction.h5")
...
# Example test input
with open("C:\\Users\\hyanx\\Documents\\repos\\KawayFSL\\terraform\\src\\test.json") as f:
    event = json.load(f)  # This will load the JSON as a dictionary
